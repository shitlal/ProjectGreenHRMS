...
public class RecruitmentEntity {
	...
	@Column(name = "FINALINTRVIEW_STATUS")

	private String finalInterview_status;
	...
	public RecruitmentEntity(Integer candidateid, String jobCode, String candidatename, String current_location,
			...
			String round_1, String assignee1, String interviewdate1, String finalInterview_status,
			String employeeCode) {
		super();
		...
		this.finalInterview_status = finalInterview_status;
	...
	public String getFinalInterview_status() {
		return finalInterview_status;
	}

	public void setFinalInterview_status(String finalInterview_status) {
		this.finalInterview_status = finalInterview_status;
	}
	...
	public String toString() {
		return "RecruitmentEntity [candidateid=" + candidateid + ", jobCode=" + jobCode + ", candidatename="
				...
				+ interviewdate1 + ", finalInterview_status=" + finalInterview_status + ", employeeCode=" + employeeCode
				+ "]";
	}
